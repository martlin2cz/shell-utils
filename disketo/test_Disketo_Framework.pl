...
my $input_1 = "test/";
my $dirs_1_ref = Disketo_Core::children_of($input_1);
...
my $input_2 = "test/";
my $dirs_2_ref = Disketo_Core::list_directory($input_2);
...
my $dirs_3_ref = Disketo_Extras::list_all_directories(@input_3);
...
my ($dirs_3a_ref, $stats_3a_ref) = Disketo_Extras::load_stats($dirs_3_ref);
...
my $dirs_4_ref = Disketo_Extras::filter_directories($dirs_3_ref, $filter_4);
...
my $pattern_5 = "ba";
my $dirs_5_ref = Disketo_Extras::filter_directories_by_pattern($dirs_3_ref, $pattern_5);
...
my $pattern_6 = "txt";
my $threshold_6 = 1;
my $dirs_6_ref = Disketo_Extras::filter_directories_by_files_pattern($dirs_3_ref, $pattern_6, $threshold_6);
...
my ($dirs_7_ref, $pairs_7_ref) = Disketo_Extras::filter_directories_matching($dirs_3_ref, $matcher_7);
...
my ($dirs_8_ref, $pairs_8_ref) = Disketo_Extras::filter_directories_of_same_name($dirs_3_ref);
...
my ($dirs_9_ref, $pairs_9_ref) = Disketo_Extras::filter_directories_with_common_files($dirs_3_ref, $min_count_9, $matcher_9);
...
my ($dirs_10_ref, $pairs_10_ref) = Disketo_Extras::filter_directories_with_common_file_names($dirs_3_ref, $min_count_9);
...
my ($dirs_11_ref, $pairs_11_ref) = Disketo_Extras::filter_directories_with_common_file_names_with_size($dirs_3_ref, $stats_3a_ref, $min_count_9);
...
Disketo_Extras::print_directories($dirs_3_ref, $printer_12);
